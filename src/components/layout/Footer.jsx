      ...
      <div className="max-w-[75rem] mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        <div className="col-span-1 md:col-span-2">
          ...
          <p className="text-gray-600 dark:text-white/60 mb-6 max-w-sm">
            Capturing timeless moments with an elite touch. We specialize in wedding, portrait, and event photography
            across Nigeria.
          </p>
          <div className="flex gap-4">
            {[Instagram, Twitter, Facebook].map((Icon, i) => (
              <a
                key={i}
                href="#"
                className="w-12 h-12 rounded-full border border-gray-300 dark:border-white/20 flex items-center justify-center text-gray-600 dark:text-white hover:border-gold hover:text-gold hover:bg-gold/10 hover:-translate-y-1 transition-all duration-300"
              >
                <Icon size={18} />
              </a>
            ))}
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3">
            {[
              ...
              <li key={link.path}>
                <Link to={link.path} className="text-gray-600 dark:text-white/60 hover:text-gold transition-colors">
                  {link.label}
                </Link>
              </li>
            ))}
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 text-gray-600 dark:text-white/60">
            ...
            <li>
              <a href="mailto:Theuniquevisuals15@gmail.com" className="hover:text-gold transition-colors">
                Theuniquevisuals15@gmail.com
              </a>
            </li>
            <li>
              <a href="tel:+2348164877157" className="hover:text-gold transition-colors">
                +234 816 487 7157
              </a>
            </li>
          </ul>
