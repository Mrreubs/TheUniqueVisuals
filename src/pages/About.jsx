...
const APPROACH = [
  { icon: Heart, title: 'Authentic Emotion', desc: 'We focus on capturing genuine, candid moments rather than stiff poses. We want your photos to feel like you.' },
  { icon: Award, title: 'Editorial Quality', desc: 'Every image goes through our meticulous post-production process to ensure a premium, magazine-ready finish.' },
  { icon: CheckCircle2, title: 'Seamless Experience', desc: 'From the first consultation to the final delivery, we provide a stress-free, luxurious experience tailored to your needs.' },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-700 dark:text-white/70 font-light mb-8 max-w-lg leading-relaxed">
              Based in Ibadan, Unique Visuals is a premium photography studio dedicated to turning your fleeting moments
              into eternal masterpieces.
            </p>
          </motion.div>
          <motion.div
          ...
          >
            <img src={`${BASE}images/_mg_0970.webp`} alt="" className="object-cover w-full h-full" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="max-w-[75rem] mx-auto px-6 mb-24 grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        >
          ...
          <p className="text-gray-700 dark:text-white/70 leading-relaxed mb-6">
            Founded over a decade ago, Unique Visuals started with a simple camera and an immense dream: to document the
            world's beauty through the lens of authenticity. What started in a small studio in Elebu, Ibadan, has
            blossomed into one of Nigeria's most sought-after photography brands.
          </p>
          <p className="text-gray-700 dark:text-white/70 leading-relaxed">
            We don't just take pictures; we craft visual legacies. Every click of the shutter is an attempt to freeze
            time, preserving the raw emotions, the stolen glances, and the vibrant celebrations that define our human
            experience.
          </p>
        </motion.div>
        ...
        >
          ...
          {APPROACH.map((item, i) => (
            <div key={i} className="flex gap-4">
              <div className="mt-1">
                <item.icon className="text-gold shrink-0" size={24} />
              </div>
              <div>
                <h4 className="text-xl font-display font-bold text-gray-900 dark:text-white mb-2">{item.title}</h4>
                <p className="text-gray-700 dark:text-white/70 leading-relaxed">{item.desc}</p>
              </div>
            </div>
          ))}
        </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {TEAM.map((member, i) => (
              ...
              >
                ...
                <h4 className="text-2xl font-display font-bold text-gray-900 dark:text-white text-center mb-2">
                  {member.name}
                </h4>
