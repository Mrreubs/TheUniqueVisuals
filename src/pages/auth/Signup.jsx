    ...
    <div className="bg-white dark:bg-dark text-gray-900 dark:text-white min-h-screen pt-32 pb-16 flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-10">
          <h2 className="text-3xl font-semibold mb-3">Create an Account</h2>
          <p className="text-gray-600 dark:text-white/60 text-sm">Join us to manage your bookings and share your experience.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-600 dark:text-white/60 mb-2">Confirm Password</label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <Lock size={18} className="text-gray-400" />
              </div>
