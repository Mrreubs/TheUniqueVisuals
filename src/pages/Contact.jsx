  ...
  return (
    <div className="bg-white dark:bg-dark text-gray-900 dark:text-white min-h-screen pt-24 pb-16">
      <div className="max-w-[75rem] mx-auto">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-light mb-6 tracking-tight">Get in <span className="font-semibold text-gold">Touch</span></h1>
          <p className="text-gray-700 dark:text-white/70 max-w-2xl mx-auto text-lg md:text-xl font-light">
            We would love to hear from you. Whether you have a question about our services, pricing, or want to book a session, we are here to help.
          </p>
        </motion.div>
              ...
              <div className="space-y-6">
                <a href="mailto:Theuniquevisuals15@gmail.com" className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900 dark:text-white group-hover:text-gold transition-colors duration-300">Theuniquevisuals15@gmail.com</p>
                  </div>
                </a>

                <a href="https://wa.me/2348164877157" target="_blank" rel="noopener noreferrer" className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900 dark:text-white group-hover:text-[#25D366] transition-colors duration-300">+234 816 487 7157</p>
                  </div>
                </a>
            ...
            <div className="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 p-8 md:p-12 rounded-3xl backdrop-blur-sm">
              ...
              {isSubmitted ? (
                <div className="bg-gold/20 border border-gold text-gray-900 dark:text-white p-6 rounded-2xl flex flex-col items-center justify-center text-center space-y-4 py-16">
                  ...
                  <p className="text-gray-600 dark:text-white/60">Thank you for reaching out. We will get back to you as soon as possible.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label htmlFor="name" className="block text-sm font-medium text-gray-600 dark:text-white/60 mb-2">Full Name</label>
                      <input 
                        type="text" 
                        id="name"
                        name="name"
                    ...
                    <div>
                      <label htmlFor="email" className="block text-sm font-medium text-gray-600 dark:text-white/60 mb-2">Email Address</label>
                      <input 
                        type="email" 
                        id="email"
                        name="email"
                  ...
                  <div>
                      <label htmlFor="phone" className="block text-sm font-medium text-gray-600 dark:text-white/60 mb-2">Phone Number</label>
                    <input 
                      type="tel" 
                      id="phone"
                      name="phone"
                  ...
                  <div>
                      <label htmlFor="message" className="block text-sm font-medium text-gray-600 dark:text-white/60 mb-2">Your Message</label>
                    <textarea 
                      id="message"
                      name="message"
